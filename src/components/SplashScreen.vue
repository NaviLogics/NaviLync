<template>
  <div class="fixed inset-0 z-[9990] flex items-center justify-center bg-[#031c2b] text-white">
    ...
    <div
      class="relative z-[9992] flex w-[min(760px,86vw)] flex-col items-center rounded-2xl border border-white/20 bg-black/20 px-10 py-12 shadow-2xl backdrop-blur-md"
    >
    ...
    <div class="fixed bottom-4 right-4 z-[9993]">
      <button class="rounded-full bg-white/10 p-1 text-white elevation-3 focus:outline-none" @click="toggleFullscreen">
