<template>
  ...
  <v-dialog v-model="widgetStore.widgetManagerVars(widget.hash).configMenuOpen" min-width="400" max-width="35%">
    <v-card class="px-8 pb-6 pt-2" :style="interfaceStore.globalGlassMenuStyles">
      <v-card-title class="text-center">{{ $t('widgetConfig.compassHud.title') }}</v-card-title>
      <v-card-text>
        <v-switch
          class="ma-1"
          :label="$t('widgetConfig.compassHud.showYawValue')"
        ...
        <v-switch
          class="ma-1"
          :label="$t('widgetConfig.compassHud.useNegativeRange')"
        ...
        <v-expansion-panels theme="dark">
          <v-expansion-panel class="bg-[#FFFFFF11] text-white mt-2">
            <v-expansion-panel-title>{{ $t('widgetConfig.compassHud.color') }}</v-expansion-panel-title>
